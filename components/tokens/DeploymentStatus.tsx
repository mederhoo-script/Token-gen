...
export function DeploymentStatus({ status, message }: DeploymentStatusProps) {
  ...
  const config = {
    deploying: { icon: "⏳", label: "Deploying contract...", cls: "bg-blue-50 text-blue-700 border-blue-200" },
    success: { icon: "✅", label: "Token deployed!", cls: "bg-green-50 text-green-700 border-green-200" },
